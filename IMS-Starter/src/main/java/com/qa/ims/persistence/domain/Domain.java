...
public enum Domain {
	...
	CUSTOMER("Information about customers"), ITEM("Information about individual Items"), ORDER("For purchasing items"),
	STOP("If you would like to close the application");
